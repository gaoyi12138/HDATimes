...
from Anomaly_Detection.exp.exp_anomaly_detection import Exp_Anomaly_Detection
...
def main():
    ...
    parser.add_argument('--llm_ckp_dir', type=str, default='D:\\.cache\\huggingface\\hub\\models--GPT2\\snapshots\\Gpt2')
    ...
    parser.add_argument('--mlp_activation', type=str, default='gelu', help='mlp activation')
    parser.add_argument('--mlp_hidden_activation', type=str, default='gelu', help='mlp activation')
