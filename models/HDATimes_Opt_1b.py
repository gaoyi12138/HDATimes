...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.hidden_dim_of_opt1b = 768 #2048
        ...
        if self.mix:
            # Initialize mark_enc_proj if mixing is enabled
            self.mark_enc_proj = nn.Linear(4096, self.hidden_dim_of_opt1b)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        if self.mix:
            ...
            x_mark_enc = self.mark_enc_proj(x_mark_enc)  # 调整 x_mark_enc 维度
